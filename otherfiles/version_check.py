...
SETUP_ITEMS = [
    "version='{0}'",
    'https://github.com/openscilab/parsipy/tarball/v{0}']
README_ITEMS = [
    "[Version {0}](https://github.com/openscilab/parsipy/archive/v{0}.zip)",
    "pip install parsipy=={0}"]
CHANGELOG_ITEMS = [
    "## [{0}]",
    "https://github.com/openscilab/parsipy/compare/v{0}...dev",
    "[{0}]:"]
PARAMS_ITEMS = ['PARSIPY_VERSION = "{0}"']
META_ITEMS = ['% set version = "{0}" %']
ISSUE_TEMPLATE_ITEMS = ["- ParsiPy {0}"]
...
FILES = {
    ...
    os.path.join("parsipy", "params.py"): PARAMS_ITEMS,
    ...
    for file_name in FILES:
        try:
            ...
            for test_item in FILES[file_name]:
                if file_content.find(test_item.format(PARSIPY_VERSION)) == -1:
